...
<style>
.content{
background-image:linear-gradient(to right,#f5f2f3,#f0e9eb);
...
<body>
<header>
<nav class="navbar navbar-expand-lg navbar-light" style="background:#7897e3">
<!--<nav class="navbar navbar-expand-lg navbar-light" style="background:#D76D77">-->
<a class="navbar-brand" href="/"><h4>User Login System</h4></a>
...
<a class="nav-item nav-link" href="/log">Logout</a></h3>
<h3>
@else
<a class="nav-item nav-link active" href="/login">Login</a>
<a class="nav-item nav-link active" href="/register">Register</a> </h3>
@endif
</div>
</div>
</nav>
